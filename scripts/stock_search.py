...
HK_NAMES = {
    ...
    "贝壳": "2423.HK",
    # 医药/生物
    "药明康德": "2359.HK", "药德康明": "2359.HK",
    "药明生物": "2269.HK",
    "石药集团": "1093.HK",
    "中国生物制药": "1177.HK",
    "康希诺": "6185.HK", "康希诺生物": "6185.HK",
    "百济神州": "6160.HK",
    "信达生物": "1801.HK",
    "君实生物": "1877.HK",
    "翰森制药": "3692.HK",
    ...
    "中国石油": "0857.HK",
    "中国石化": "0386.HK",
    "中国海洋石油": "0883.HK", "中海油": "0883.HK",
    "中国神华": "1088.HK",
    # 消费/其他
    "比亚迪股份": "1211.HK", "比亚迪": "1211.HK",
    "中芯国际": "0981.HK",
    "九福来": "8611.HK",
    "李宁": "2331.HK",
...
def _search_hk_names(q: str) -> list:
    ...
    # exact match first
    if q in HK_NAMES:
        return _search_yf(HK_NAMES[q])
    # substring: query is contained in a key, or key is contained in query
    hits = []
    seen = set()
    for name, ticker in HK_NAMES.items():
        if q in name or name in q:
            if ticker not in seen:
                seen.add(ticker)
                hits += _search_yf(ticker)
    return hits
